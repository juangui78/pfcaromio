    ...
    <div id="app" className='home-container' style={{ height: '100vh' }}>
      ...
      <Routes>
        ...
        <Route
          path='/home'
          element={
            typeUser === 'Admin' && <DashboardSeller userData={userData} setUserData={setUserData} /> || //! Intercanbiar por "Seller"
            typeUser === 'Seller' && <DashboardAdmin userData={userData} setUserData={setUserData} /> || //! Intercanbiar por "Admin"
            typeUser === 'Buyer' &&
            <>
              <Slide visible={true} />
              {
